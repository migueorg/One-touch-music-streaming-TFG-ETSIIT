...
\begin{itemize}
    \item Debe de tener compatibilidad nativa con las mismas librerías empleadas en la parte del dispositivo Android.
\end{itemize}
...
\begin{itemize}
    \item Se valorará la sencillez en cuanto instalación del lenguaje en modo \emph{headless}.
    \item Se valorará la simpleza en cuanto a ejecución de los archivos ejecutables.
\end{itemize}
...
\begin{todolist}
    ...
    binarios pre compilados accesibles oficialmente desde GitHub o instalarlo
    desde un repositorio de terceros llamado \emph{SDKMAN} el cual si trae el
    paquete de Kotlin en su catálogo, pero que para usarlo es necesario
