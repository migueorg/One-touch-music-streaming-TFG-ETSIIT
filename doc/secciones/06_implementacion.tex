...
SourceDataLine de Java [REFERENCIAR AQUÍ A ESA CLASE], la cual es capaz de
...
Sin embargo, a pesar de los cortes, la transmisión es estable y mantenida a
tiempo real, sin retardo en el audio (ante unas mínimas condiciones de red
aceptables), por lo que finalmente y tras muchos cambios, replanteamientos y
semanas de investigación y desarrollo que parecían no llevar a ningún lugar; los
objetivo de envío y recepción de audio cumplían los requisitos para un PMV.
